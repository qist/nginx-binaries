...
# 1) 替换 yum 源为官方 vault.centos.org (x86_64;EOL 后官方归档,外网可访问,全走代理)
...
# 3) cmake 3.27(Kitware 预编译 x86_64;xz 要求 >=3.20)
...
ln -sf /tmp/cmake-3.27.9-linux-x86_64/bin/cmake /usr/local/bin/cmake
...
bash scripts/ci-build.sh /workspace "$NGINX_VER" glibc_amd64 tar.gz
